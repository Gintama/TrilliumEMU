...
enum Opcodes
{
    ...
    */
    ...
    CMSG_SWAP_ITEM                                   = 0x03ABB, //
    CMSG_SWAP_INV_ITEM                               = 0x0E66A, //
